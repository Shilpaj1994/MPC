...
public:
	...
	void operator()(ADvector& fg, const ADvector& vars) {
		...
		const int cte_cost_weight = 3000; //3000
		const int epsi_cost_weight = 1600;
		const int v_cost_weight = 5; //40
		const int delta_cost_weight = 5;
		const int a_cost_weight = 10;
		const int delta_change_cost_weight = 45;
		const int a_change_cost_weight = 2;
